...
using OnionArchitectureProject.Common.Infrastructure;
using System;
...
namespace OnionArchitectureProject.Infrastructure.Persistence.Context
{
    internal class SeedData
    {
        ...
        public async Task SeedAsync(IConfiguration configuration)
        {
            ...
            dbContextBuilder.UseSqlServer(configuration["OnionArchitectureProjectDbConnectionString"]);
            var context = new OnionArchitectureProjectContext(dbContextBuilder.Options);
            var users = GetUser();
